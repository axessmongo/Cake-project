  ...
  return (
    <div>
      <section className="container">
        <h1 className="text-center mt-3"> <span className="text-danger display-4 fw-bold">C</span>elebrate <span className="text-danger display-4 fw-bold">M</span>ilestones</h1>
        <p className="text-center">With our memorable gifts</p>
        <p className="display-6 text-center"><span className="text-danger display-4 fw-bold">B</span>IRTHDAY & <span className="text-danger display-4 fw-bold">A</span>NNIVERSARY <span className="text-danger display-4 fw-bold">G</span>IFTS</p>
